...
public class TesseractExample2 {
    ...
    private static String sourceFolderPath ="C:\\Users\\deepak.meghwal\\Documents\\Docs\\OCR\\test1\\imageFile\\";
...
//        File file = new File(sourceFolderPath +"invoice.pdf");
    ...
    public static void runOCROnSingleRect(File file) throws TesseractException{
//        File file = new File(sourceFolderPath +"invoice.pdf");
        ...
        try {
            ...
            Rectangle rectangle = new Rectangle(0, 500, 500, 500);
            String result = instance.doOCR(file, rectangle);
//            String result = "Bill To |\nCMA CGM--Norfolk :\nDept: --- :\\nAddress: J\\nPhone: ---\\n\\nJ\\n";
            result = StringUtils.substringBetween(result, "Bill To", "Dept");
...
//            String result1 = instance.doOCR(file);
//
//            System.out.println("result1 => "+result1);
//            sb.append(result1);
//
//            Rectangle rectangle = new Rectangle(1400, 50, 950, 200);
//            String result = instance.doOCR(file, rectangle);
//
//            result = StringUtils.substringAfter(result, "Invoice#");
//            result = result.replaceAll(" |\n", "");
////            result = result.trim();
//
//            System.out.println("result => "+result);
...
//            Rectangle rectangle2 = new Rectangle(800, 500, 300, 500);
//            String result2 = instance.doOCR(file, rectangle2);
//
//            result2 = StringUtils.substringAfter(result2, "Date Sent");
...
//                dateSent = formatter.parse(result2);
//
//
//
//                DateFormat formatter2 = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");
//                String dateSentStr = formatter2.format(dateSent);
//                System.out.println("dateSentStr="+dateSentStr);
//            }catch (Exception e){
//                System.out.println(e.getMessage());
//            }
...
//
//
//            Rectangle rectangle1 = new Rectangle(500, 500, 300, 500);
//            String result1 = instance.doOCR(file, rectangle1);
//
//            result1 = StringUtils.substringBetween(result1, "Remit To", "Dept");
...
//            sb.append(result2);
    ...
    public static PredictionConfig jsonTOPredictionConfig(){
        ...
        Gson gson = new Gson();
        try {
            JsonReader jsonReader = new JsonReader(new FileReader("./src/main/resources/config/BlumeInvoice2.json"));
...
//        }
    ...
    public static void countShipmentItems(ITesseract instance, File file, TableItem tableItem){
        try {
            ...
            Rectangle commentRect = new Rectangle(2100, 1000, 500, 2000);
